    ...
    <footer id="footer" class="bg-black dark">
        ...
        <div class="container padded-vertical-40">
            <div class="row">
                <div class="col-md-2 col-sm-6 margin-bottom-20-sm margin-bottom-20-xs">
                    <h5 class="text-light">
                ...
                <div class="col-md-4 col-sm-6 margin-bottom-20-xs">
                    <h5 class="text-light">
                        <strong>Contact</strong> Us</h5>
                    <!-- List with Icons -->
                    <ul class="list-unstyled list-unstyled-icons">
                        <li>
                            <i class="text-muted inline-icon fa fa-map-marker"></i>
                            <strong>Address:</strong>
                            <span class="text-muted">1A Hughes Avenue, Alagomeji, Sabo, Lagos</span>
                        </li>
                        <li>
                            <i class="text-muted inline-icon fa fa-comment"></i>
                            <strong>E-mail:</strong>
                            <span class="text-muted">
                                <a href="#">Horpey@thenest.com</a>
                            </span>
                        </li>
                        <li>
                            <i class="text-muted inline-icon fa fa-phone"></i>
                            <strong>Phone:</strong>
                            <span class="text-muted">+234 8113852536</span>
                        </li>
                    </ul>
                </div>
                <div class="col-md-2 col-sm-6 margin-bottom-20-xs">
                    <h5 class="text-light">
                        <strong>Social</strong> Media</h5>
                    <!-- Social Icons -->
                    <a href="#" class="icon icon-circle icon-filled icon-xs icon-facebook margin-right-20">
                        <i class="fa fa-facebook"></i>
                    </a>
                    <a href="#" class="icon icon-circle icon-filled icon-xs icon-twitter margin-right-20">
                        <i class="fa fa-twitter"></i>
                    </a>
                    <a href="#" class="icon icon-circle icon-filled icon-xs icon-google-plus margin-right-20">
        ...
        <div class="copyright bordered-top">
            <div class="container padded-vertical-30">
                <span class="text-muted">Copyright
                    <strong>The Nest - Trainings | Incubation</strong> 2018&copy;</span>
                <ul class="list-inline pull-right text-muted margin-bottom-0">
                    ...
                    <li>
                        <a href="<?php echo base_url('signup')?>">Sign in!</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <script type="text/javascript" src="<?php echo base_url('assets/js/page-loader.js'); ?>"></script>
    ...
    <script type="text/javascript">
       $( document ).ready(function() {
            $(".co-work-form").submit(function(e){
                e.preventDefault();
            });
            $(".submit-toggle").click(function(e){
